...
protocol SupplierGroupValidatorProtocol {
    func validateCreate(_ req: Request) throws -> SupplierGroup.Create
    func validateUpdate(_ req: Request) throws -> (uuid: UUID, content: SupplierGroup.Update)
...
class SupplierGroupValidator: SupplierGroupValidatorProtocol {
    ...
    func validateCreate(_ req: Request) throws -> SupplierGroup.Create {
        typealias CreateContent = SupplierGroup.Create
        do {
    ...
    func validateUpdate(_ req: Request) throws -> (uuid: UUID, content: SupplierGroup.Update) {
        typealias UpdateContent = SupplierGroup.Update
        do {
