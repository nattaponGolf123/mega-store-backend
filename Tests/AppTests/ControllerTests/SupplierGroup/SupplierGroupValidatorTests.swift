//
//  SupplierGroupValidatorTests.swift
//  
//
...
final class SupplierGroupValidatorTests: XCTestCase {
    
    var app: Application!
    
    var validator: SupplierGroupValidator!
    ...
    func testValidateCreate_WithValidRequest_ShouldReturnCorrectValues() {
        let content = SupplierGroupRequest.Create(name: "Test")
    ...
    func testValidateCreate_WithLessThen3CharName_ShouldThrow() {
        let content = SupplierGroupRequest.Create(name: "T")
        let request = mockRequest(content: content)
    ...
    func testValidateCreate_WithOver200CharName_ShouldThrow() {
        ...
        let content = SupplierGroupRequest.Create(name: name)
        let request = mockRequest(content: content)
    ...
    func testValidateUpdate_WithNoId_ShouldThrowError() {
        let content = SupplierGroupRequest.Update(name: "Test")
        let request = mockRequest(content: content)
    ...
    func testValidateUpdate_WithLessThen3CharName_ShouldThrow() {
        let id = UUID()
        let content = SupplierGroupRequest.Update(name: "T")
        let request = mockRequest(url: "/mock/:id",
                                      pathParameters: ["id": id],
                                      content: content)
    ...
    func testValidateUpdate_WithOver200CharName_ShouldThrow() {
        let id = UUID()
        let name = String(repeating: "A", count: 201)
        let content = SupplierGroupRequest.Update(name: name)
        let request = mockRequest(url: "/mock/:id",
                                      pathParameters: ["id": id],
                                      content: content)
    ...
    func testValidateUpdate_WithOnlyDescription_ShouldNotThrow() {
        let id = UUID()
        let content = SupplierGroupRequest.Update(description: "Test")
        let request = mockRequest(url: "/mock/:id",
                                  pathParameters: ["id": id],
                                  content: content)
