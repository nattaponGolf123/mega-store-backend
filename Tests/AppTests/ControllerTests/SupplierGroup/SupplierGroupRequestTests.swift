//
//  SupplierGroupRequestTests.swift
//  
//
...
final class SupplierGroupRequestTests: XCTestCase {    
    ...
    func testCreateInit_WithDefaults_ShouldReturnCorrectValues() {
        let create = SupplierGroupRequest.Create(name: "Group")
    ...
    func testCreateInit_WithCustomValues_ShouldReturnCorrectValues() {
        let create = SupplierGroupRequest.Create(name: "Group", description: "Description")
    ...
    func testUpdateInit_WithDefaults_ShouldReturnCorrectValues() {
        let update = SupplierGroupRequest.Update()
    ...
    func testUpdateInit_WithCustomValues_ShouldReturnCorrectValues() {
        let update = SupplierGroupRequest.Update(name: "Group", 
