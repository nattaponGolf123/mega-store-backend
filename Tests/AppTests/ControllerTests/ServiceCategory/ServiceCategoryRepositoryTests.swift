//
//  ServiceCategoryRepositoryTests.swift
//  
//
...
final class ServiceCategoryRepositoryTests: XCTestCase {
    
    var app: Application!
    var db: Database!
    var contactGroupRepository: ServiceCategoryRepository!
    ...
    override func setUp() async throws {
        ...
        contactGroupRepository = ServiceCategoryRepository()
    ...
    func testFetchAll_ShouldReturnAllGroup() async throws {
        ...
        // Given
        let group1 = ServiceCategory(name: "Group1")
        let group2 = ServiceCategory(name: "Group2", deletedAt: Date())
    ...
    func testFetchAll_WithSortByNameDesc_ShouldReturnGroup() async throws {
        ...
        // Given
        let group1 = ServiceCategory(name: "Group1")
        let group2 = ServiceCategory(name: "Group2")
        try await group1.create(on: db)
        try await group2.create(on: db)
    ...
    func testFetchById_ShouldReturnGroup() async throws {
        ...
        // Given
        let group = ServiceCategory(name: "Group")
    ...
    func testCreate_ShouldCreateGroup() async throws {
        ...
        // Given
        let request = ServiceCategoryRequest.Create(name: "Group")
    ...
    func testUpdate_WithNameAndDescription_ShouldUpdateGroup() async throws {
        ...
        let request = ServiceCategoryRequest.Update(name: "Group2",
                                                 description: "Des")
    ...
    func testUpdate_WithDescription_ShouldUpdateGroup() async throws {
        ...
        let request = ServiceCategoryRequest.Update(name: nil,
                                                 description: "Des")
...
private extension ServiceCategoryRepositoryTests {
    struct Stub {
        static var group40: [ServiceCategory] {
            (0..<40).map { ServiceCategory(name: "Group\($0)") }
        }
    }
}
