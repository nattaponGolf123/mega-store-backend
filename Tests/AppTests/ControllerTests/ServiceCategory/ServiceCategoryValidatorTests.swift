//
//  ServiceCategoryValidatorTests.swift
//  
//
...
final class ServiceCategoryValidatorTests: XCTestCase {
    
    var app: Application!
    
    var validator: ServiceCategoryValidator!
    ...
    func testValidateCreate_WithValidRequest_ShouldReturnCorrectValues() {
        let content = ServiceCategoryRequest.Create(name: "Test")
    ...
    func testValidateCreate_WithLessThen3CharName_ShouldThrow() {
        let content = ServiceCategoryRequest.Create(name: "T")
        let request = mockRequest(content: content)
    ...
    func testValidateCreate_WithOver200CharName_ShouldThrow() {
        ...
        let content = ServiceCategoryRequest.Create(name: name)
        let request = mockRequest(content: content)
    ...
    func testValidateUpdate_WithNoId_ShouldThrowError() {
        let content = ServiceCategoryRequest.Update(name: "Test")
        let request = mockRequest(content: content)
    ...
    func testValidateUpdate_WithLessThen3CharName_ShouldThrow() {
        let id = UUID()
        let content = ServiceCategoryRequest.Update(name: "T")
        let request = mockRequest(url: "/mock/:id",
                                      pathParameters: ["id": id],
                                      content: content)
    ...
    func testValidateUpdate_WithOver200CharName_ShouldThrow() {
        let id = UUID()
        let name = String(repeating: "A", count: 201)
        let content = ServiceCategoryRequest.Update(name: name)
        let request = mockRequest(url: "/mock/:id",
                                      pathParameters: ["id": id],
                                      content: content)
    ...
    func testValidateUpdate_WithOnlyDescription_ShouldNotThrow() {
        let id = UUID()
        let content = ServiceCategoryRequest.Update(description: "Test")
        let request = mockRequest(url: "/mock/:id",
                                  pathParameters: ["id": id],
                                  content: content)
