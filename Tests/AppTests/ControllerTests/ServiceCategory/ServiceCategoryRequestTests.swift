//
//  ServiceCategoryRequestTests.swift
//  
//
...
final class ServiceCategoryRequestTests: XCTestCase {    
    ...
    func testCreateInit_WithDefaults_ShouldReturnCorrectValues() {
        let create = ServiceCategoryRequest.Create(name: "Group")
    ...
    func testCreateInit_WithCustomValues_ShouldReturnCorrectValues() {
        let create = ServiceCategoryRequest.Create(name: "Group", description: "Description")
    ...
    func testUpdateInit_WithDefaults_ShouldReturnCorrectValues() {
        let update = ServiceCategoryRequest.Update()
    ...
    func testUpdateInit_WithCustomValues_ShouldReturnCorrectValues() {
        let update = ServiceCategoryRequest.Update(name: "Group", 
