...
final class ContactRepositoryTests: XCTestCase {
    ...
    var app: Application!
    var db: Database!
    var contactGroupRepository: ContactRepository!
    ...
    override func setUp() async throws {
        ...
        contactGroupRepository = ContactRepository()
...
//        
//        // Given
//        let group1 = Contact(name: "Group1")
//        let group2 = Contact(name: "Group2", deletedAt: Date())
...
//        // Given
//        let group1 = Contact(name: "Group1")
//        let group2 = Contact(name: "Group2")
//        try await group1.create(on: db)
//        try await group2.create(on: db)
//        
//        // When
...
//        
//        // Given
//        let request = ContactRequest.Create(name: "Group")
//        
//        // When
...
//        try await group.create(on: db)
//        
//        let request = ContactRequest.Update(name: "Group2",
//                                                 description: "Des")
//        
//        let fetchById = ContactRequest.FetchById(id: group.id!)
//        
//        // When
...
//        try await group.create(on: db)
//        
//        let request = ContactRequest.Update(name: nil,
//                                                 description: "Des")
//        
//        let fetchById = ContactRequest.FetchById(id: group.id!)
//        
...
//                                                 description: "Des")
//        
//        let fetchById = ContactRequest.FetchById(id: group1.id!)
//        
//        // When
//        do {
...
//                                                 description: "Des")
//        
//        let fetchById = ContactRequest.FetchById(id: UUID())
//        
//        // When
//        do {
//            _ = try await contactGroupRepository.update(byId: fetchById,
