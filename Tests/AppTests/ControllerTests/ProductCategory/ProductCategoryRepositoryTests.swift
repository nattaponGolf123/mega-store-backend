//
//  ProductCategoryRepositoryTests.swift
//  
//
...
final class ProductCategoryRepositoryTests: XCTestCase {
    
    var app: Application!
    var db: Database!
    var contactGroupRepository: ProductCategoryRepository!
    ...
    override func setUp() async throws {
        ...
        contactGroupRepository = ProductCategoryRepository()
    ...
    func testFetchAll_ShouldReturnAllGroup() async throws {
        ...
        let group2 = ProductCategory(name: "Group2", deletedAt: Date())
    ...
    func testFetchById_ShouldReturnGroup() async throws {
        ...
        // Given
        let group = ProductCategory(name: "Group")
    ...
    func testCreate_ShouldCreateGroup() async throws {
        ...
        // Given
        let request = ProductCategoryRequest.Create(name: "Group")
    ...
    func testUpdate_WithNameAndDescription_ShouldUpdateGroup() async throws {
        ...
        let request = ProductCategoryRequest.Update(name: "Group2",
                                                 description: "Des")
    ...
    func testUpdate_WithDescription_ShouldUpdateGroup() async throws {
        ...
        let request = ProductCategoryRequest.Update(name: nil,
                                                 description: "Des")
...
private extension ProductCategoryRepositoryTests {
    struct Stub {
        static var group40: [ProductCategory] {
            (0..<40).map { ProductCategory(name: "Group\($0)") }
        }
    }
}
