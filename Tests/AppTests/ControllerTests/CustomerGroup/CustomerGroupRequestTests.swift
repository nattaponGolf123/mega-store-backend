//
//  CustomerGroupRequestTests.swift
//  
//
...
final class CustomerGroupRequestTests: XCTestCase {    
    ...
    func testCreateInit_WithDefaults_ShouldReturnCorrectValues() {
        let create = CustomerGroupRequest.Create(name: "Group")
    ...
    func testCreateInit_WithCustomValues_ShouldReturnCorrectValues() {
        let create = CustomerGroupRequest.Create(name: "Group", description: "Description")
    ...
    func testUpdateInit_WithDefaults_ShouldReturnCorrectValues() {
        let update = CustomerGroupRequest.Update()
    ...
    func testUpdateInit_WithCustomValues_ShouldReturnCorrectValues() {
        let update = CustomerGroupRequest.Update(name: "Group", 
