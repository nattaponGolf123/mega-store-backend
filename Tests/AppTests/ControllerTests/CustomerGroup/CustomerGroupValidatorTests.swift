//
//  CustomerGroupValidatorTests.swift
//  
//
...
final class CustomerGroupValidatorTests: XCTestCase {
    
    var app: Application!
    
    var validator: CustomerGroupValidator!
    ...
    func testValidateCreate_WithValidRequest_ShouldReturnCorrectValues() {
        let content = CustomerGroupRequest.Create(name: "Test")
    ...
    func testValidateCreate_WithLessThen3CharName_ShouldThrow() {
        let content = CustomerGroupRequest.Create(name: "T")
        let request = mockRequest(content: content)
    ...
    func testValidateCreate_WithOver200CharName_ShouldThrow() {
        ...
        let content = CustomerGroupRequest.Create(name: name)
        let request = mockRequest(content: content)
    ...
    func testValidateUpdate_WithNoId_ShouldThrowError() {
        let content = CustomerGroupRequest.Update(name: "Test")
        let request = mockRequest(content: content)
    ...
    func testValidateUpdate_WithLessThen3CharName_ShouldThrow() {
        let id = UUID()
        let content = CustomerGroupRequest.Update(name: "T")
        let request = mockRequest(url: "/mock/:id",
                                      pathParameters: ["id": id],
                                      content: content)
    ...
    func testValidateUpdate_WithOver200CharName_ShouldThrow() {
        let id = UUID()
        let name = String(repeating: "A", count: 201)
        let content = CustomerGroupRequest.Update(name: name)
        let request = mockRequest(url: "/mock/:id",
                                      pathParameters: ["id": id],
                                      content: content)
    ...
    func testValidateUpdate_WithOnlyDescription_ShouldNotThrow() {
        let id = UUID()
        let content = CustomerGroupRequest.Update(description: "Test")
        let request = mockRequest(url: "/mock/:id",
                                  pathParameters: ["id": id],
                                  content: content)
