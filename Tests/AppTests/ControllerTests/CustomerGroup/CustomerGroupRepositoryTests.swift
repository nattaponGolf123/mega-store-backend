//
//  CustomerGroupRepositoryTests.swift
//  
//
...
final class CustomerGroupRepositoryTests: XCTestCase {
    
    var app: Application!
    var db: Database!
    var contactGroupRepository: CustomerGroupRepository!
    ...
    override func setUp() async throws {
        ...
        contactGroupRepository = CustomerGroupRepository()
    ...
    func testFetchAll_ShouldReturnAllGroup() async throws {
        ...
        // Given
        let group1 = CustomerGroup(name: "Group1")
        let group2 = CustomerGroup(name: "Group2", deletedAt: Date())
    ...
    func testFetchAll_WithSortByNameDesc_ShouldReturnGroup() async throws {
        ...
        // Given
        let group1 = CustomerGroup(name: "Group1")
        let group2 = CustomerGroup(name: "Group2")
        try await group1.create(on: db)
        try await group2.create(on: db)
    ...
    func testFetchById_ShouldReturnGroup() async throws {
        ...
        // Given
        let group = CustomerGroup(name: "Group")
    ...
    func testCreate_ShouldCreateGroup() async throws {
        ...
        // Given
        let request = CustomerGroupRequest.Create(name: "Group")
    ...
    func testUpdate_WithNameAndDescription_ShouldUpdateGroup() async throws {
        ...
        let request = CustomerGroupRequest.Update(name: "Group2",
                                                 description: "Des")
    ...
    func testUpdate_WithDescription_ShouldUpdateGroup() async throws {
        ...
        let request = CustomerGroupRequest.Update(name: nil,
                                                 description: "Des")
...
private extension CustomerGroupRepositoryTests {
    struct Stub {
        static var group40: [CustomerGroup] {
            (0..<40).map { CustomerGroup(name: "Group\($0)") }
        }
    }
}
